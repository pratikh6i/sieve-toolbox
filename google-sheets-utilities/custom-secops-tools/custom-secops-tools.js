 ...
 * --------------------------
 * 1. JSON Extractors (Original)
 * 2. Basic IP Batch (Original - ipinfo.io)
 * 3. Advanced IP Kundli (New - RIPEstat + AbuseIPDB)
 */
...
function onOpen() {
  SpreadsheetApp.getUi()
      ...
      .addSeparator()
      .addItem('Get IP Country & Org (Batch)', 'getIpData') // Your Original Function
      // --- NEW UPGRADE ---
      .addSeparator()
      .addItem('Get IP Advanced Kundli (Deep)', 'getAdvancedKundli') // The New Deep Dive
      .addToUi();
}

// =================================================================================
// PART 1: YOUR ORIGINAL JSON EXTRACTORS (UNTOUCHED)
// =================================================================================
...
// =================================================================================
// PART 2: YOUR ORIGINAL IP FUNCTION (UNTOUCHED)
// Uses ipinfo.io Batch
// =================================================================================
...
// =================================================================================
// PART 3: NEW ADVANCED KUNDLI FUNCTION (ADD-ON)
